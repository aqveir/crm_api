        ...
        <footer class="main-footer style-five style-six">
                                ...
                                <div class="contact-widget footer-widget">
                                    ...
                                    <div class="widget-content">
                                        <ul class="contact-info clearfix">
                                            ...
                                            <li><i class="fas fa-phone"></i><a href="tel:+919423009635">(091) 942 - 300 - 9635</a></li>
                                            <li><i class="fas fa-envelope"></i><a href="mailto:info@crmomni.com">info@crmomni.com</a></li>
                                        </ul>
                                    </div>
            ...
            <div class="copyright d-flex">
                <div class="flex-grow-0 footer-bottom ml-3">
                    &copy; 2020 
                    <a href="https://www.ellaisys.com/" target="_blank">Ellai Information Systetms Private Limited</a>. All rights reserved
                </div>
