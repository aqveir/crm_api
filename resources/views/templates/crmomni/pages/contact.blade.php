                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-6 col-sm-12 info-column">
                                <div class="single-info-box">
                                    ...
                                    <div class="phone"><a href="tel:+919158999635">(+91) 942 - 300 - 9635</a></div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-12 info-column">
                                <div class="single-info-box">
                                    ...
                                    <h2>E-mail</h2>
                                    <div class="text">Start working with Landrick that can provide everything</div>
                                    <div class="phone"><a href="mailto:info@crmomni.com">info@crmomni.com</a></div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-12 info-column">
                                <div class="single-info-box">
