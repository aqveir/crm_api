...
return [
    ...
    */
    'github' => [
        ...
        'redirect' => env('GITHUB_CLIENT_REDIRECT', 'contact/login/github/callback'),
    ],
    'facebook' => [
        ...
        'redirect' => env('FACEBOOK_CLIENT_REDIRECT', 'contact/login/facebook/callback'),
    ],
    'twitter' => [
        'client_id' => env('TWITTER_CLIENT_ID'),
        'client_secret' => env('TWITTER_CLIENT_SECRET'),
        'redirect' => env('TWITTER_CLIENT_REDIRECT', 'contact/login/facebook/callback'),
    ],
    'linkedin' => [
        'client_id' => env('LINKEDIN_CLIENT_ID'),
        'client_secret' => env('LINKEDIN_CLIENT_SECRET'),
        'redirect' => env('LINKEDIN_CLIENT_REDIRECT', 'contact/login/linkedin/callback'),
    ],
    'google' => [
        'client_id' => env('GOOGLE_CLIENT_ID'),
        'client_secret' => env('GOOGLE_CLIENT_SECRET'),
        'redirect' => env('GOOGLE_CLIENT_REDIRECT', 'contact/login/google/callback'),
    ],
