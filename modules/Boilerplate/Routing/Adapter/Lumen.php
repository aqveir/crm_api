...
namespace Modules\Boilerplate\Routing\Adapter;
...
use Modules\Boilerplate\Exception\UnknownVersionException;
...
class Lumen implements Adapter
{
    ...
    protected function removeMiddlewareFromApp()
    {
        ...
        foreach ($oldMiddlewares as $middle) {
            if ((new ReflectionClass($middle))->hasMethod('terminate') && $middle != 'Modules\Boilerplate\Http\Middleware\Request') {
