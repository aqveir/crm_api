...
use Modules\Boilerplate\Http\Response\Factory;

/**
 * @property \Modules\Boilerplate\Dispatcher                                            $api
 * @property \Illuminate\Auth\GenericUser|\Illuminate\Database\Eloquent\Model           $user
 * @property \Modules\Boilerplate\Auth\Auth                                             $auth
 * @property \Modules\Boilerplate\Http\Response\Factory                                 $response
 */
trait Helpers
{
    /**
     ...
     *
     * @param string|\Modules\Boilerplate\Contract\Http\RateLimit\Throttle  $class
     * @param array                                                     $options
     *
     * @return void
     */
     ...
     *
     * @return \Modules\Boilerplate\Dispatcher
     */
    public function api()
    {
     ...
     *
     * @return \Modules\Boilerplate\Auth\Auth
     */
     ...
     *
     * @return \Modules\Boilerplate\Http\Response\Factory
     */
