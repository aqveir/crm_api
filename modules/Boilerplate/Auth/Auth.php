...
namespace Modules\Boilerplate\Auth;
...
class Auth
{
     ...
     *
     * @var \Modules\Boilerplate\Contract\Auth\Provider
     */
    ...
    protected function throwUnauthorizedException(array $exceptionStack)
    {
        ...
        if ($exception === null) {
            $exception = new UnauthorizedHttpException('Boilerplate', 'Failed to authenticate because of bad credentials or an invalid authorization header.');
        }
     ...
     *
     * @return \Modules\Boilerplate\Contract\Auth\Provider
     */
