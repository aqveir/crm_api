...
use Modules\Boilerplate\Http\Middleware\Auth;
...
class LaravelServiceProvider extends BoilerplateServiceProvider
{
    ...
    public function boot()
    {
        ...
        $this->publishes([base_path('config/api.php') => config_path('api.php')]);
        ...
        https://github.com/Boilerplate/api/issues/1668
        This is already done by laravel service provider, and works with Boilerplate router
