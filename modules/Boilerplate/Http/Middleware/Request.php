...
use Modules\Boilerplate\Event\RequestWasMatched;
use Modules\Boilerplate\Http\Request as HttpRequest;
use Illuminate\Contracts\Container\Container;
use Modules\Boilerplate\Contract\Debug\ExceptionHandler;
use Modules\Boilerplate\Contract\Http\Request as RequestContract;
...
class Request
{
     ...
     *
     * @var \Modules\Boilerplate\Contract\Debug\ExceptionHandler
     */
    protected $exception;
     ...
     *
     * @var \Modules\Boilerplate\Http\Validator
     */
    protected $validator;
     ...
     * @param \Modules\Boilerplate\Contract\Debug\ExceptionHandler   $exception
     * @param \Modules\Boilerplate\Routing\Router                    $router
     * @param \Modules\Boilerplate\Http\RequestValidator             $validator
    ...
    /**
     * Send the request through the Boilerplate router.
     *
