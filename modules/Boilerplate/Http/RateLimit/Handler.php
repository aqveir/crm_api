...
namespace Modules\Boilerplate\Http\RateLimit;
...
use Modules\Boilerplate\Http\RateLimit\Throttle\Route;
use Modules\Boilerplate\Contract\Http\RateLimit\Throttle;
use Modules\Boilerplate\Contract\Http\RateLimit\HasRateLimiter;
...
class Handler
{
     ...
     *
     * @var \Modules\Boilerplate\Contract\Http\RateLimit\Throttle
     */
    protected $throttle;
    ...
    {
        return sprintf('Boilerplate.api.%s.%s', $key, $this->getRateLimiter());
    }
     ...
     *
     * @param string|\Modules\Boilerplate\Contract\Http\RateLimit\Throttle $throttle
     *
     * @return void
     */
     ...
     *
     * @return \Modules\Boilerplate\Contract\Http\RateLimit\Throttle
     */
     ...
     *
     * @param callable|\Modules\Boilerplate\Http\RateLimit\Throttle $throttle
     *
     * @return void
     */
