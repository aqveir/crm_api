 ...
 */
class ContactGoogleService extends BaseService
{
    /**
     ...
     * @return bool
     */
    public function sync(string $orgHash, Collection $payload, string $ipAddress=null)
    {
        ...
        try {
            ...
            Log::error('ContactGoogleService:makeCall:ModelNotFoundException:' . $e->getMessage());
        } catch (Exception $e) {
            log::error('ContactGoogleService:makeCall:Exception:' . $e->getMessage());
