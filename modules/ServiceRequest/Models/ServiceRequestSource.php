...
use Modules\ServiceRequest\Models\Traits\Relationship\ServiceRequestSourceRelationship;

/**
 * Eloquent Model for ServiceRequests
 */
class ServiceRequestSource extends Model {

    use ServiceRequestSourceRelationship;
    ...
    public function __construct(array $attributes = [])
    {
        ...
        $this->table = config('crmomni-migration.table_name.service_request.source');
    }
